...
# hyperparameter
rnd_l = 4 # random walk length


network = 'ca-CondMat'
f_net = '/home/ruimin/anaconda3/network_analysis/data/%s/%s.elst.csv'%(network, network)
f_com = '/home/ruimin/anaconda3/network_analysis/data/%s/%s.walktrap.com'%(network, network)
f_out = '/home/ruimin/anaconda3/network_analysis/data/%s/%s.walktrap.out'%(network, network)
f_ref = ''


print('loading graph...')
graph = Graph(f_net, 'edge list', directed=False, weighted=False, memory_control=True)
graph.read_community(f_com, algo='Walktrap')
